...
count(m.ID) as No_of_accidents from "DEVELOPER_DB"."TIRUPATHIRAO_SCHEMA"."CONVERT_DATE" as m

left outer join "DEVELOPER_DB"."TIRUPATHIRAO_SCHEMA"."CALENDER_DIMENTIONS_TABLE" as c on m.DATE_ID=c.DATE_ID

left outer join "DEVELOPER_DB"."TIRUPATHIRAO_SCHEMA"."US_ACCIDENT_ADDRESS_INCREMENTAL_DIM" as D on m.CITY=D.CITY and m.COUNTRY=D.COUNTRY and
...
left outer join "DEVELOPER_DB"."TIRUPATHIRAO_SCHEMA"."US_ACCIDENT_DRON_INCREMENTAL_LOAD" as e on
...
left outer join  "DEVELOPER_DB"."TIRUPATHIRAO_SCHEMA"."US_ACCIDENT_REASON_INCREMENT_DIM" as r on
